class ApiEndpoint {
  /// API Endpoints
  static const trendingNews = '/football-get-trendingnews';
  static const matchDetail = '/football-get-match-detail';
  static const currentLivescore = '/football-current-live';
  static const matchesByDate = '/football-get-matches-by-date';
  static const matchStats = '/football-get-match-event-all-stats';
